    ...
    public class WorldSelectionScreen implements Screen {
        ...
        private void createUI() {
            ...
            titleLabel.setFontScale(1.5f); // Increase font scale

// Adjust padding
            mainTable.add(titleLabel).colspan(3).pad(20); // Increase padding
            mainTable.row();
    ...
    // Update the createWorldEntry method in WorldSelectionScreen:
        ...
        private Table createWorldEntry(WorldData world) {
            ...
            entry.pad(15); // Increase padding

            // Use larger font for world name
            Label worldNameLabel = new Label(world.getName(), skin);
            worldNameLabel.setFontScale(1.5f);
            ...
            entry.add(worldNameLabel).expandX().fillX();
            entry.row();
            ...
            entry.addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    entry.setBackground(skin.newDrawable("default-pane", new Color(0.4f, 0.4f, 0.4f, 1)));
                    selectWorld(world);
                }
            });
