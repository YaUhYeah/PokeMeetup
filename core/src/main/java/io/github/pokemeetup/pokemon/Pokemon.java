...
public class Pokemon {
    ...
    // Update calculateStats method to account for status effects

    // Add this method to handle flinching
    public void setFlinched(boolean flinched) {
        this.flinched = flinched;
    }

    public boolean isConfused() {
        return confusedTurns > 0;
    }

    // Add these methods for confusion
    public void setConfused(int turns) {
        this.confusedTurns = turns;
    }
...
//            GameLogger.info("Rendering Pokémon: " + name + " at position: " + position);
    ...
    private int getExperienceForNextLevel() {
        // Using a simple cubic growth formula
